import { Colour, Ball, Paddle, Coord, Rectangle, GameField, Player, GameResult, Move } from '@type/gameplay';
...
export class GameplayService {
	...
	constructor(player1: Socket, player2: Socket) {
		...
		this.player1 = { userId: player1.user.id, socket: player1, score: 0 };
		this.player2 = { userId: player2.user.id, socket: player2, score: 0 };
